...
function createBaseMsgMint(): MsgMint {
  return { creator: "", amountInt: "", denomOut: "" };
}
...
export const MsgMint = {
  encode(message: MsgMint, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.amountInt !== "") {
      writer.uint32(18).string(message.amountInt);
    }
    if (message.denomOut !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.amountInt = reader.string();
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): MsgMint {
    return {
      ...
      amountInt: isSet(object.amountInt) ? String(object.amountInt) : "",
  ...
  toJSON(message: MsgMint): unknown {
    ...
    if (message.amountInt !== "") {
      obj.amountInt = message.amountInt;
    }
    if (message.denomOut !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgMint>, I>>(object: I): MsgMint {
    ...
    message.amountInt = object.amountInt ?? "";
...
function createBaseMsgMintResponse(): MsgMintResponse {
  return { creator: "", amountInt: "", amountOut: "" };
}
